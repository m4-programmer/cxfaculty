...
export default function AdminPostsEdit() {
    ...
    function submit(event: FormEvent<HTMLFormElement>) {
        ...
        form.put(`/admin/posts/${post.slug}`, {
            preserveScroll: true,
        });
    }
        ...
        <>
            ...
            <main className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm uppercase tracking-[0.32em] text-amber-300">Edit post</p>
                        <h1 className="mt-3 text-4xl font-black tracking-tight text-white sm:text-5xl">Update blog post</h1>
                    </div>
                    <Link
                        href="/admin/posts"
